...
function determineWhichPiece(pieces, boardCoordinates) {
  let whichPiece = [];
...
export default function ChessBoard({ isMoveValid, onChange, onClick, pieces, selectedPiece }) {
        ...
        return (
          <div key={yCoordinate} className="ChessBoard__row">
            {arrayOfEight.map((element, index) => {
              ...
              const whichPiece = determineWhichPiece(pieces, boardCoordinates);
